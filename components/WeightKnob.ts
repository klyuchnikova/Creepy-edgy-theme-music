  ...
  override render() {
    ...
    return html`
      ...
      <svg
        ...
        <g style=${dotStyle}>
          <circle cx="14" cy="0" r="3" fill="#ff0000" />
        </g>
        <path
    ...
    return html`<svg viewBox="0 0 80 80">
        ...
        <defs>
          ...
          <linearGradient
            ...
            <stop stop-color="#111" stop-opacity="0.5" />
            <stop offset="1" stop-color="#333" stop-opacity="0.3" />
          </linearGradient>
          <radialGradient
            id="f3"
            cx="0"
            ...
            <stop offset="0.6" stop-color="#222" />
            <stop offset="1" stop-color="#111" stop-opacity="0.7" />
          </radialGradient>
          <linearGradient
            id="f5"
            x1="40"
